...
public class Animal {
  ...
  // Bytes can hold the values between -128 to 127 034     
  private byte age;
   
  // Longs can hold the values between -2 ^ 63 to (2 ^ 63) - 1
  private long uniqueID;
   
  // Chars are unsigned ints that represent UTF-16 codes from 0 to 65,535 040     
  ...
  public void setUniqueID() {
      ...
      // Generates a random number between 1 and 1000000 153         this.uniqueID = minNumber + (long)(Math.random() * ((maxNumber - minNumber) + 1));
